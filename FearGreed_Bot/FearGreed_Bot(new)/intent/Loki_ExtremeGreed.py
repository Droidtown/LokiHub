...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[一][路]發":
        resultDICT["ExtremeGreed"].append(10)
        pass
    ...
    if utterance == "[前三天]暴漲[700][點]":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[前三天]暴漲[了][近][700][點]":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[前三天]狂漲[了][近][700][點]":
        resultDICT["ExtremeGreed"].append(10)
        pass
    ...
    if utterance == "[航運類股][狂]拉":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[航運類股]大漲":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[航運類股]大漲[700][點]":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[航運類股]暴漲":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[航運類股]狂漲":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[航運類股]狂漲[700][點]":
        resultDICT["ExtremeGreed"].append(10)
        pass

    if utterance == "[這]還有[多的]紙箱":
        resultDICT["ExtremeGreed"].append(10)
        pass
