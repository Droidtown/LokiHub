...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[也][代表][市場][資金][在]觀望[鮑爾][的][談話內容]":
        resultDICT["Neutral"].append(10)
        pass

    if utterance == "[反彈]仍是看[量][決定][一切]":
        resultDICT["Neutral"].append(10)
        pass
    ...
    if utterance == "[我][會][稍微]停看聽[觀察][一][下]":
        resultDICT["Neutral"].append(10)
        pass

    if utterance == "[所以]這[邊][我][還是][要]提醒大家[有些][不確定性]":
        resultDICT["Neutral"].append(10)
        pass
    ...
    if utterance == "[至少]幅度不會那麼大":
        resultDICT["Neutral"].append(10)
        pass

    if utterance == "[若][不幸][回測][此][低點][需]特別注意[是][否][守的住]":
        resultDICT["Neutral"].append(10)
        pass
