...
# -*- coding:utf-8 -*-
"""
Name：       Loki Intent Update Tool
Author：     Droidtown
Date：       2021-02-22
Email：      info@droidtown.co
Example：    Updater.py -o <old_intent(s)_dir> -n <new_intent(s)_dir>
Descrption： Updater.py 會將 <old_intent(s)_dir> 目錄中檔名符合 Loki_ 開頭
