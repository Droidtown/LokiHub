...
def testIntent():
    # money
    print("[TEST] money")
    inputLIST = ['對方很摳','對方很窮','對方沒錢','對方堅持AA','另一半沒錢','對方不存錢','對方堅持生','對方太小氣','對方很刻薄','對方月薪28k','對方沒存款','對方當我atm','沒錢養小孩','月入只有2萬','對方不願意aa','他太守財奴了','另一半手頭緊','對方一事無成','對方一無所有','對方借錢不還','對方口袋空空','對方小氣過頭','對方收入不多','對方收入很低','對方是守財奴','對方是窮光蛋','對方欠錢不還','對方沒房沒車','對方沒有儲蓄','對方薪水不高','對方要我買房','約見面誰付錢','月收只有2萬多','月薪僅有2萬多','對方說房租要AA','連保險套都要AA','借了對方幾十萬','另一半很愛計較','另一半經濟拮据','同居還不付房租','對方不幫忙付錢','對方只愛我的錢','對方想跟我借錢','對方捨不得花錢','對方月收只有25k','對方當我提款機','對方要我買房子','對方都不帶錢包','對方錢賺得很少','約見面誰要付錢','月收入僅2萬多元','月收入只有2萬多','對方不願意跟我aa','連保險套錢都要AA','他真的都沒在存錢','借了對方好幾十萬','因為經濟能力分手','因為經濟能力自卑','對方一直跟我借錢','對方出門不帶錢包','對方只喜歡我的錢','對方只在乎我的錢','對方對金錢太計較','對方希望跟我借錢','對方打算跟我借錢','對方會偷家裡的錢','對方月薪少得可憐','對方經濟狀況不好','對方經濟狀況很差','第一次見面誰付錢','連保險套的錢也要AA','連保險套都要跟我AA','對方什麼都要我付錢','對方只看中我的財力','對方只追求我的金錢','對方對花費非常吝嗇','對方經濟條件很普通','我賺的是我男友兩倍','第一次見面誰要付錢','連保險套的開銷也要AA','連保險套錢都要跟我AA','因為我沒有網路吃到飽','因為經濟問題想提分手','對方只對我的錢有興趣','跟對方的經濟非常懸殊','每個月只有2萬多的薪水','因為我沒在用網路吃到飽','對方只對我的財產感興趣','對方只對我的錢感到心動','一個月只有2萬多元的收入','對方連保險套也要和我分攤','對方連保險套都要和我平分','對方連買保險套都要我分攤','感情都是建立在金錢關係上','沒辦法回送金額相當的禮物','覺得我是一直花他錢的女生','不想讓對方覺得都是他在負擔','對方只對我錢包裡的東西感興趣','勸對方不要花費超過自己經濟能力','有一定的經濟能力才能給對方好的未來']
