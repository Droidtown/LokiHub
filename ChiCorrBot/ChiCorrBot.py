...
explanationDICT = {'prg':'這種情況下，你想描述的是正在進行的事件，所以需要在動詞前加「在」。',
                   ...
                   'hai':'「還」的用法可分為三種，還+動詞、還有+名詞、還是=或者，依序的舉例為還在睡、還有學生、學生還是老師。',
                   ...
                   'faceToface':'要表達實體課程，可以說「面對面的課」或「實體課程」；用網路上課則為「線上課程」或「遠距課程」。',
                   ...
                   'again':'「再」+動詞，表示該動作重複；動詞+「過」，表示該動作已發生。',
                   ...
                   'genju':'「根據」+名詞，建議改成「某某說的內容」，例如根據媽媽說的內容、根據老師說的內容等等。'
