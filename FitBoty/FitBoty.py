...
def testIntent():
    ...
    # weight
    print("[TEST] weight")
    inputLIST = ['50公斤','我50初','我50多','我50幾','我50公斤','我大約50公斤']
    testLoki(inputLIST, ['weight'])
    print("")

    # height
    print("[TEST] height")
    inputLIST = ['150公分','我150公分','身高150公分']
    testLoki(inputLIST, ['height'])
    print("")

    # age
    print("[TEST] age")
    inputLIST = ['我17歲','我快17歲','我今年17歲','我剛滿17歲']
    testLoki(inputLIST, ['age'])
    print("")

    # gender
    print("[TEST] gender")
    inputLIST = ['是女生','不是女的','是個男的']
