...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[150]":
        if re.search("\d+\\.?\d*", args[0]) == None:
            args[0] = re.sub('公分|米', '', args[0])
            resultDICT["height"] = cn2num.transform(args[0])
        elif re.search("\d+\\.?\d*", args[0]) != None:
            resultDICT["height"] = float(args[0])
        
    if utterance == "[1米][5]":
        if re.search("\d+米", args[0]) == None:
            args[0] = re.sub('公分|米', '', args[0])
            meter = cn2num.transform(args[0])
        elif re.search("\d+米", args[0]) != None:
            meter = list(articut.parse(args[0],level="lv3")["number"].values())[0]
        
        if re.search("\d+", args[1]) == None:
            args[1] = re.sub('公分|米', '', args[1])
            cm = cn2num.transform(args[1])
        elif re.search("\d+", args[1]) != None:
            cm = float(args[1])
        resultDICT["height"] = meter*100 + cm
    ...
    if utterance == "[150公分]":
        if re.search("\d+\\.?\d*", args[0]) == None:
            ...
            resultDICT["height"] = list(articut.parse(args[0],level="lv3")["number"].values())[0]
    ...
    if utterance == "[1米][5公分]":
        ...
        if re.search("\d+", args[1]) == None:
            ...
            cm = float(re.search("\d+", args[1]).group(0))
        resultDICT["height"] = meter*100 + cm
