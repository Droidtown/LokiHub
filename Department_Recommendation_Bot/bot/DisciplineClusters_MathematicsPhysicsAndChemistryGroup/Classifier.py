...
parent_directory = os.path.join(BASE_PATH, os.pardir)
...
accountInfo = json.load(open(os.path.join(parent_directory, "account.info"), encoding="utf-8"))
USERNAME = accountInfo["username"]
LOKI_KEY = accountInfo["loki_key_DisciplineClusters_MathematicsPhysicsAndChemistryGroup"]
POST_INTERVAL_SEC = 5
