...
def testIntent():
    ...
    # price
    print("[TEST] price")
    inputLIST = ['多少錢','一盒蛋多少','皮蛋多少錢','芭樂賣多少','蘋果怎麼賣','一塊肉怎麼賣','一條魚多少錢','螃蟹價格高嗎','高麗菜的價格','我要買一盒皮蛋','瘦肉一斤多少錢','菠菜一把多少錢','葡萄現在多少錢','現在一盒皮蛋要多少錢','請告訴我一盒蛋多少錢','我想買一盒蛋需要帶多少錢','現在一條白鯧的價格是多少']
    ...
    # recipe
    print("[TEST] recipe")
    inputLIST = ['他能做什麼','有甚麼料理','梨子的做法','白果怎麼煮','芭樂怎麼吃','藍莓的作法','芭樂要怎麼弄','芭樂該怎麼弄','香蕉怎麼處理','紅棗可以做什麼','紅棗有甚麼料理','紅蘿蔔可以幹嘛','芭樂有甚麼做法','葡萄該怎麼料理','葡萄該怎麼處理','蘋果相關的料理','香菇有甚麼作法','烏魚子可以怎麼做','皮蛋可以用烤的嗎','芭樂可以做成什麼','有什麼大白菜的料理','有甚麼紫甘藍的作法','有甚麼紫甘藍的做法','葡萄有什麼料理方式','芭樂可以做成什麼料理','請問烏魚子該怎麼料理','我想知道番茄有甚麼料理','我想知道蘋果相關的料理','我想知道蘋果能做什麼料理']
...
def testConflict():
    ...
    # price
    price_inputLIST = ['多少錢','一盒蛋多少','皮蛋多少錢','芭樂賣多少','蘋果怎麼賣','一塊肉怎麼賣','一條魚多少錢','螃蟹價格高嗎','高麗菜的價格','我要買一盒皮蛋','瘦肉一斤多少錢','菠菜一把多少錢','葡萄現在多少錢','現在一盒皮蛋要多少錢','請告訴我一盒蛋多少錢','我想買一盒蛋需要帶多少錢','現在一條白鯧的價格是多少']
    ...
    # recipe
    recipe_inputLIST = ['他能做什麼','有甚麼料理','梨子的做法','白果怎麼煮','芭樂怎麼吃','藍莓的作法','芭樂要怎麼弄','芭樂該怎麼弄','香蕉怎麼處理','紅棗可以做什麼','紅棗有甚麼料理','紅蘿蔔可以幹嘛','芭樂有甚麼做法','葡萄該怎麼料理','葡萄該怎麼處理','蘋果相關的料理','香菇有甚麼作法','烏魚子可以怎麼做','皮蛋可以用烤的嗎','芭樂可以做成什麼','有什麼大白菜的料理','有甚麼紫甘藍的作法','有甚麼紫甘藍的做法','葡萄有什麼料理方式','芭樂可以做成什麼料理','請問烏魚子該怎麼料理','我想知道番茄有甚麼料理','我想知道蘋果相關的料理','我想知道蘋果能做什麼料理']
