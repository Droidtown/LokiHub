...
PROJECT_NAME = "whats_in_my_fridge"
...
def testIntent():
    ...
    # time_limit
    print("[TEST] time_limit")
    inputLIST = ['一小時','十分鐘','慢慢來','省時的','簡單的','不限時間','快速料理','時間不限','短時間內','越快越好','可以慢慢做','有充裕時間','現在就要煮','簡單快速的','要快速上菜','今天中午要吃','沒有時間限制','等一下要吃的']
    testLoki(inputLIST, ['time_limit'])
    print("")

    # serving
    print("[TEST] serving")
    inputLIST = ['一','1人份','一人吃','多人份','小份的','少量的','一個人吃','只做一份','家庭聚餐','情侶晚餐','派對用的','一個人晚餐','我要一人份','給兩個人吃']
    testLoki(inputLIST, ['serving'])
    print("")

    # ingredient
    print("[TEST] ingredient")
    inputLIST = ['番茄','番茄加雞蛋','番茄和雞蛋','番茄配雞蛋','雞蛋及番茄','番茄 雞蛋 蔥','雞蛋搭配番茄','剩下番茄跟雞蛋','番茄、雞蛋跟蔥','番茄和雞蛋料理','雞蛋及番茄食譜','番茄和雞蛋怎麼煮','今天買了番茄跟雞蛋','冰箱裡有番茄和雞蛋']
    testLoki(inputLIST, ['ingredient'])
    print("")
