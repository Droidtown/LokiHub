...
MODULE_DICT = {
    ...
    "LLM": import_from_path("whats_in_my_fridge_lib_LLM", os.path.join(CWD_PATH, "lib/LLM.py")),
    "Project": import_from_path("whats_in_my_fridge_lib_Project", os.path.join(CWD_PATH, "lib/Project.py")),
}
"""
Account 變數清單
[變數] BASE_PATH         => 根目錄位置
