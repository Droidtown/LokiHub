...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "I would get a galaxy case and keyboard cover to match to protect my laptop.":
        for arg in args:
            resultDICT["items"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"

    if utterance == "I would personally choose an Apple Macbook Pro or possibly a Macbook Air as a replacement":
        for arg in args:
            resultDICT["items"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("I would get a galaxy case and keyboard cover to match to protect my laptop.", "I would get a galaxy case and keyboard cover to match to protect my laptop.", [], {}, {})
    pprint(resultDICT)