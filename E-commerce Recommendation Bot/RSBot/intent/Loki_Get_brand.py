...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "I like __brandname__ products":
        for arg in args:
            resultDICT["brand"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"

    if utterance == "__brandname__ brand":
        for arg in args:
            resultDICT["brand"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"

    if utterance == "__brandname__ or __brandname__":
        for arg in args:
            resultDICT["brand"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"

    if utterance == "a __brandname__ one":
        for arg in args:
            resultDICT["brand"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"

    if utterance == "an __brandname__ mac":
        for arg in args:
            resultDICT["brand"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"

    if utterance == "probably __brandname__":
        for arg in args:
            resultDICT["brand"].append(arg)
        resultDICT["response"] = getReply2(args, refDICT)
        resultDICT["source"] = "reply"
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("__brandname__ brand", "__brandname__ brand", [], {}, {})
    pprint(resultDICT)